...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                {{-- Form Start --}}
                <form action="{{ route('categories.update', $category) }}" class="w-100" method="post"
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                ...
                                                <label class="custom-file-label" for="imageInput"
                                                    id="imageInputLabel">{{$category->image ?? "Choose file"}}</label>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="package-image-container">
                                            <img id="categoryImagePreview"
                                                src="{{($category->image ) ? asset("/storage/".$category->image) : asset('/assets/images/placeholder.png')}}"
                                                alt="Thumbnail"
