                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" id="packagename" required class="form-control"
                                        placeholder="Goa Boom Beach" name="name" value="{{ $package->name }}" />
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Category</label>
                                    <select class="select2 select2-hidden-accessible" name="category_id"
                                        data-placeholder="Select a Category" required style="width: 100%;"
                                        data-select2-id="7" tabindex="-1" aria-hidden="true">
                                        {{-- <option value="" selected disabled>Select a Category</option> --}}
                                        @foreach ($categories as $index => $category)
                                        <option value="{{ $category->id }}" @if ($category->id == $package->category_id)
                        ...
                        <div class="row">
                            <div class="form-group col">
                                ...
                                <textarea class="summernote-ov" id="" cols="30" rows="8" name="overview"
                                    placeholder="Goa have . . . .">{{ $package->overview }}</textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="imageInput"
                                                id="imageInputLabel">{{($package->image != "" ? $package->image : "Choose file")}}</label>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div
                                        ...
                                        <input type="checkbox" class="custom-control-input" id="customSwitch3"
                                            @if($package->status) checked @endif name="status">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="package-image-container">
                                    <img id="packageImagePreview"
                                        src="{{($package->image ? asset("/storage/".$package->image) : url('/assets/images/placeholder.png'))}}"
                                        alt="image"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group px-4 col-12">
                            <textarea class="summernote-it" cols="30" rows="15"
                                name="itineraries">{{ $package->itineraries }}</textarea>
                        </div>
                    </div>
                    {{-- Itineraries End --}}
